            ...
            foreach ($xml->attribute as $attribute) {
                ...
                if (isset($attribute['serialized-path'])) {
                    try {
                        ...
                        throw new MappingException(sprintf('The "serialized-path" value must be a valid property path for the attribute "%s" of the class "%s".', $attributeName, $classMetadata->getName()), 4429712583);
                    }
                }
