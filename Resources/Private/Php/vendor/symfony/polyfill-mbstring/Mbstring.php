...
final class Mbstring
{
    ...
    public static function mb_internal_encoding($encoding = null)
    {
        ...
        throw new \ValueError(sprintf('Argument #1 ($encoding) must be a valid encoding, "%s" given', $encoding), 3796764529);
    }
    ...
    public static function mb_language($lang = null)
    {
        ...
        throw new \ValueError(sprintf('Argument #1 ($language) must be a valid language, "%s" given', $lang), 6163894483);
    }
    ...
    public static function mb_str_split($string, $split_length = 1, $encoding = null)
    {
        ...
        if (1 > $split_length = (int) $split_length) {
            ...
            throw new \ValueError('Argument #2 ($length) must be greater than 0', 1333538092);
        }
    ...
    public static function mb_substitute_character($c = null)
    {
        ...
        throw new \ValueError('Argument #1 ($substitute_character) must be "none", "long", "entity" or a valid codepoint', 9070531320);
    }
    ...
    public static function mb_str_pad(string $string, int $length, string $pad_string = ' ', int $pad_type = \STR_PAD_RIGHT, ?string $encoding = null): string
    {
        if (!\in_array($pad_type, [\STR_PAD_RIGHT, \STR_PAD_LEFT, \STR_PAD_BOTH], true)) {
            throw new \ValueError('mb_str_pad(): Argument #4 ($pad_type) must be STR_PAD_LEFT, STR_PAD_RIGHT, or STR_PAD_BOTH', 2959997272);
        }
        ...
        if (self::mb_strlen($pad_string, $encoding) <= 0) {
            throw new \ValueError('mb_str_pad(): Argument #3 ($pad_string) must be a non-empty string', 3478597048);
        }
    ...
    private static function assertEncoding(string $encoding, string $errorFormat): void
    {
        try {
            ...
            throw new \ValueError(sprintf($errorFormat, $encoding), 1488201339);
        }

        // BC for PHP 7.3 and lower
        if (!$validEncoding) {
            throw new \ValueError(sprintf($errorFormat, $encoding), 9720857478);
        }
    }
}
