...
class Crawler implements \Countable, \IteratorAggregate
{
    ...
    public function add(\DOMNodeList|\DOMNode|array|string|null $node): void
    {
        if ($node instanceof \DOMNodeList) {
            ...
            throw new \InvalidArgumentException(sprintf('Expecting a DOMNodeList or DOMNode instance, an array, a string, or null, but got "%s".', get_debug_type($node)), 4888347165);
        }
    }
    ...
    public function addNode(\DOMNode $node): void
    {
        ...
        if (null !== $this->document && $this->document !== $node->ownerDocument) {
            throw new \InvalidArgumentException('Attaching DOM nodes from multiple documents in the same crawler is forbidden.', 1997487128);
        }
    ...
    {
        if (!$this->nodes) {
            throw new \InvalidArgumentException('The current node list is empty.', 1316554285);
        }
    ...
    {
        if (!$this->nodes) {
            throw new \InvalidArgumentException('The current node list is empty.', 1355633756);
        }
    ...
    {
        if (!$this->nodes) {
            throw new \InvalidArgumentException('The current node list is empty.', 8124753741);
        }
    ...
    {
        if (!$this->nodes) {
            throw new \InvalidArgumentException('The current node list is empty.', 8744538453);
        }
    ...
    {
        if (!$this->nodes) {
            throw new \InvalidArgumentException('The current node list is empty.', 4883500060);
        }
    ...
    {
        if (!$this->nodes) {
            throw new \InvalidArgumentException('The current node list is empty.', 8487592946);
        }
    ...
    public function attr(string $attribute/* , string $default = null */): ?string
    {
        ...
        if (!$this->nodes) {
            ...
            throw new \InvalidArgumentException('The current node list is empty.', 8574816580);
        }
    ...
    {
        if (!$this->nodes) {
            throw new \InvalidArgumentException('The current node list is empty.', 5488617762);
        }
    ...
    public function text(?string $default = null, bool $normalizeWhitespace = true): string
    {
        if (!$this->nodes) {
            ...
            throw new \InvalidArgumentException('The current node list is empty.', 1310406665);
        }
    ...
    public function html(?string $default = null): string
    {
        if (!$this->nodes) {
            ...
            throw new \InvalidArgumentException('The current node list is empty.', 1171619504);
        }
    ...
    {
        if (!\count($this)) {
            throw new \InvalidArgumentException('The current node list is empty.', 5394600283);
        }
    ...
    public function evaluate(string $xpath): array|self
    {
        if (null === $this->document) {
            throw new \LogicException('Cannot evaluate the expression on an uninitialized crawler.', 7928535441);
        }
    ...
    {
        if (!$this->nodes) {
            throw new \InvalidArgumentException('The current node list is empty.', 1118241311);
        }

        $node = $this->getNode(0);

        if (!$node instanceof \DOMElement) {
            throw new \InvalidArgumentException(sprintf('The selected node should be instance of DOMElement, got "%s".', get_debug_type($node)), 7391992526);
        }
    ...
    public function links(): array
    {
        ...
        foreach ($this->nodes as $node) {
            if (!$node instanceof \DOMElement) {
                throw new \InvalidArgumentException(sprintf('The current node list should contain only DOMElement instances, "%s" found.', get_debug_type($node)), 4875215804);
            }
    ...
    {
        if (!\count($this)) {
            throw new \InvalidArgumentException('The current node list is empty.', 8136128639);
        }

        $node = $this->getNode(0);

        if (!$node instanceof \DOMElement) {
            throw new \InvalidArgumentException(sprintf('The selected node should be instance of DOMElement, got "%s".', get_debug_type($node)), 8700527420);
        }
    ...
    public function images(): array
    {
        ...
        foreach ($this as $node) {
            if (!$node instanceof \DOMElement) {
                throw new \InvalidArgumentException(sprintf('The current node list should contain only DOMElement instances, "%s" found.', get_debug_type($node)), 1420754320);
            }
    ...
    {
        if (!$this->nodes) {
            throw new \InvalidArgumentException('The current node list is empty.', 2454884377);
        }

        $node = $this->getNode(0);

        if (!$node instanceof \DOMElement) {
            throw new \InvalidArgumentException(sprintf('The selected node should be instance of DOMElement, got "%s".', get_debug_type($node)), 9655998636);
        }
    ...
    private function createCssSelectorConverter(): CssSelectorConverter
    {
        if (!class_exists(CssSelectorConverter::class)) {
            throw new \LogicException('To filter with a CSS selector, install the CssSelector component ("composer require symfony/css-selector"). Or use filterXpath instead.', 9937734916);
        }
